...
class MatchingService:
    ...
    def calculate_match_score(
        ...
        user_skills_text = " ".join(user.skills).lower()
        ...
        internship_skills_texts = [
            " ".join(internship.required_skills).lower()
            for internship in internships
        ]
        
        # Combine all texts for TF-IDF vectorization
        all_texts = [user_skills_text] + internship_skills_texts
        ...
        try:
            ...
            # If vectorization fails, return internships with 0 match score
            return [
                MatchedInternship(
                    _id=internship.id,
                    title=internship.title,
